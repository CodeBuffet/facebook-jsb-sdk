...
public class FacebookJsbSDK {
	private static Activity mActivity = null;
	private static Context mContext;
	private static FacebookJsbSDK facebookVan = null;

	private static final String Tag = "FacebookVan";

	public FacebookJsbSDK(Activity activity) {
		mActivity = activity;
		facebookVan = this;
	...
	public static String api(String graphPath, String method, String params,
		...
		if (session != null && session.isOpened()) {
			...
			Request request = new Request(session, graphPath, parameters,
					httpMethod, new FacebookJsbSDK.RequestCallback(cbIndex));
